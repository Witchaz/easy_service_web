...
export default function CustomerEdit() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await fetch("https://easy-service.prakasitj.com/customers/editcustomers", {
                method: "POST",
                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md w-full max-w-2xl">
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            required
                        />
                        {formErrors.name && <p className="text-red-500">{formErrors.name}</p>} {/* ข้อผิดพลาดสำหรับชื่อ */}
                    </div>
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            required
                        />
                        {formErrors.tel && <p className="text-red-500">{formErrors.tel}</p>} {/* ข้อผิดพลาดสำหรับโทรศัพท์ */}
                    </div>
                    <div className="mb-4">
                        <label>Address *</label>
                        <input
                            ...
                            required
                        />
                        {formErrors.address && <p className="text-red-500">{formErrors.address}</p>} {/* ข้อผิดพลาดสำหรับที่อยู่ */}
                    </div>
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            required
                        />
                        {formErrors.tax_id && <p className="text-red-500">{formErrors.tax_id}</p>} {/* ข้อผิดพลาดสำหรับ TAX ID */}
                    </div>
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            required
                        />
                        {formErrors.province && <p className="text-red-500">{formErrors.province}</p>} {/* ข้อผิดพลาดสำหรับจังหวัด */}
                    </div>
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            required
                        />
                        {formErrors.credit_limit && <p className="text-red-500">{formErrors.credit_limit}</p>} {/* ข้อผิดพลาดสำหรับ Credit Limit */}
                    </div>
