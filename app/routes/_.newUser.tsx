    ...
    if (formData.credit_limit >= 0) {
      ...
      try {
        const response = await fetch(
          "https://easy-service.prakasitj.com/customers/addNewCustomer",
          {
            method: "POST",
            headers: {
  ...
  return (
    <>
      <div className="flex flex-col items-center min-h-screen bg-gray-100">
        <h2 className="text-2xl font-semibold text-lime-600 mt-8 mb-6">
          เพิ่มข้อมูลลูกค้า
        </h2>
        <form
        ...
        >
          {["name", "tel", "address", "tax_id", "province"].map(
            (field, idx) => (
