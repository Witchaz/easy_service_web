  ...
  return (
    <>
      <div className="flex flex-col items-center min-h-screen bg-gray-100 p-8">
        ...
        <div
          className="bg-white p-6 rounded-lg shadow-md w-[800px] h-[500px] max-w-full mb-6 overflow-y-auto"
          style={{ maxHeight: "400px" }}
        >
          {machines.map((machine, index) => (
            <div
              key={machine.id}
              className="flex justify-between items-center bg-gray-50 p-4 rounded-lg shadow-sm mb-4"
            >
              <div>
                <p>
                ...
                <p>
                  <strong>Serial Number:</strong> {machine.sn}
                </p>
                <p>
                  <strong>Model / Type:</strong> {machine.model}
                </p>
                <p>
