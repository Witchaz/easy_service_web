...
export default function MachineEdit() {
  ...
  const handleChange = (e: {
    target: { name: any; value: any; checked: any; type: any };
  }) => {
  ...
  const handleBack = () => {
    navigate("/machineList", {
      state: { ...formData, details: machines, formDataLast },
    });
  };
        ...
        <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-2xl">
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-6 flex justify-between">
              ...
              <button
                type="button"
                className="bg-red-600 text-white shrink border-white border-2 hover:bg-red-800 p-2 rounded-lg"
