      ...
      const fetchWorkDetails = async () => {
        try {
          const response = await fetch(
            `https://easy-service.prakasitj.com/works/searchByID/${workId}`
          );
          if (!response.ok)
            throw new Error(
      ...
      <div className="flex flex-col items-center min-h-screen bg-gray-100">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-2xl">
          <div>
            ...
            <p>
              <strong>ชื่อลูกค้า:</strong> {work.customerName}
            </p>
            <p>
            ...
            <p>
              <strong>ช่างผู้รับผิดชอบ:</strong> {work.engineer}
            </p>
            <p>
              <strong>ค่าใช้จ่ายซ่อมเครื่อง:</strong> ฿{work.powerSupply}
            </p>
            <p>
              <strong>ค่าใช้จ่ายอื่นๆ:</strong> ฿{work.partsCost}
            </p>
            <p>
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            <button
              onClick={() => handleEdit("powerSupply")}
